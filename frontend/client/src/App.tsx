...
import ConfigureInfrastructurePage from "@/pages/configure-infrastructure";
...
function PrivateRoutes() {
  return (
    <Switch>
      ...
      <Route path="/configure-infrastructure" component={ConfigureInfrastructurePage} />
...
function AppRouter() {
  ...
  const isRepoOptionalRoute = isRepoConnectRoute || isProfileRoute || isSettingsRoute;
  ...
  React.useEffect(() => {
    ...
    if (isAuthenticated && !isLandingRoute && !isAuthRoute && !isRepoOptionalRoute && !selectedRepo) {
  ...
  if (!selectedRepo && !isRepoOptionalRoute) {
